...
function getModel() {
        var str='';
        var val=document.getElementById('makeName');
	...
	$.ajax({          
        	type: "GET",
        	url: "get_model.php",
        	data:'make_id='+str, //make or model?
    ...
    <div>
        <div class="row1">
            <label>Make:</label><br /> <select
                id="makeName" name="makeName" 
                class="demoInputBox"
                onChange="getModel();" multiple size=4>
...
?>
        ...
        <div class="row1">
            <label>Model:</label><br /> <select name="modelName"
                id="modelName" class="demoInputBox" multiple size=5>
